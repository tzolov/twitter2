...
public abstract class TwitterTrendLocationProcessorIntegrationTests {
	...
	@TestPropertySource(properties = { "twitter.connection.rawJson=false" })
	public static class TwitterAvailableTrendsTests extends TwitterTrendLocationProcessorIntegrationTests {
		...
		public void testOne() {
			...
			assertThat(payload, containsString("countryName"));
			assertThat(payload, containsString("placeCode"));
			assertThat(payload, not(containsString("placeType")));

			System.out.println(received.getPayload());
		}
	}

	@TestPropertySource(properties = { "twitter.connection.rawJson=true" })
	public static class TwitterAvailableTrendsTwitterJsonTests extends TwitterTrendLocationProcessorIntegrationTests {
		...
		public void testOne() {
			...
			String payload = received.getPayload().toString();
			assertThat(payload, containsString("placeType"));

			assertThat(payload, not(containsString("placeCode")));
			assertThat(payload, not(containsString("countryName")));
		}
	}

	@TestPropertySource(properties = {
			"twitter.connection.rawJson=true",
			"twitter.trend.location.closest.lat='52.379189'",
			"twitter.trend.location.closest.lon='4.899431'",
	})
	public static class TwitterClosestTrendsTests extends TwitterTrendLocationProcessorIntegrationTests {
	...
	@Import(TwitterTrendLocationProcessorConfiguration.class)
