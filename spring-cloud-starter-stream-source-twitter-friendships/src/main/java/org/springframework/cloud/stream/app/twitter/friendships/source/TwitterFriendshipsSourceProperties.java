...
@Validated
public class TwitterFriendshipsSourceProperties {

	public enum FriendshipsRequestType {followers, friends}

	/**
	 * Selects between followers or friends APIs.
	 */
	@NotNull
	private TwitterFriendshipsSourceProperties.FriendshipsRequestType type = FriendshipsRequestType.followers;
