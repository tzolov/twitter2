...
public class TwitterFriendshipsSourceFunctionConfiguration {
	...
	private static final Log logger = LogFactory.getLog(TwitterFriendshipsSourceFunctionConfiguration.class);
	...
	public Supplier<List<User>> followersSupplier(TwitterFriendshipsSourceProperties properties,
	...
	public Supplier<List<User>> friendsSupplier(TwitterFriendshipsSourceProperties properties,
			Twitter twitter, Cursor cursorState) {
		return () -> {
			try {
				PagableResponseList<User> users;
